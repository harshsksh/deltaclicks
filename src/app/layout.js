...
export const metadata = {
  ...
  title: {
    default: 'KUFLON COMMUNICATIONS LLP - Digital Marketing Agency',
    template: '%s | KUFLON COMMUNICATIONS LLP',
  },
  ...
  authors: [{ name: 'KUFLON COMMUNICATIONS LLP' }],
  creator: 'KUFLON COMMUNICATIONS LLP',
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://deltaclicks.com',
    siteName: 'KUFLON COMMUNICATIONS LLP',
    title: 'KUFLON COMMUNICATIONS LLP - Digital Marketing Agency',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'KUFLON COMMUNICATIONS LLP - Digital Marketing Agency',
      },
    ],
  },
  twitter: {
